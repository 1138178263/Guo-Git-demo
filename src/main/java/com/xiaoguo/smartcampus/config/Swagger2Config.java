package com.xiaoguo.smartcampus.config;
...
/**
 * Swagger2配置信息
 * 浏览器搜索：http://localhost:9001/swagger-ui.html
 */
@Configuration
@EnableSwagger2
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.xiaoguo.smartcampus.controller"))
                //过滤掉admin路径下的所有页面
